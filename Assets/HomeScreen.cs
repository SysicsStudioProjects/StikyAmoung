...
public class HomeScreen : MonoBehaviour
{
    ...
    private const string InterstitialAdUnitId = "74ab0d8e18339bc1";
    private const string RewardedAdUnitId = "b514d8ccc43460f8";
    private const string RewardedInterstitialAdUnitId = "ENTER_REWARD_INTER_AD_UNIT_ID_HERE";
    private const string BannerAdUnitId = "1bef008e5822bbcd";
